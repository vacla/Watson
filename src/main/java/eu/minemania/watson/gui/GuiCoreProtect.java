...
public class GuiCoreProtect extends GuiBase
{
    ...
    public void initGui()
    {
        ...
        this.addWidget(new WidgetInfoIcon(xButton + offset, y + 4, Icons.INFO_11, "watson.gui.label.plugin.info.button", label));
        ...
        if (coreProtectInfo.getCoreProtectMode() != CoreProtectMode.PURGE)
        {
            ...
            this.addLabel(x, y, width, 20, 0xFFFFFFFF, label);
            offset = this.getStringWidth(label) + 4;
            this.addWidget(new WidgetInfoIcon(x + offset, y + 4, Icons.INFO_11, "watson.gui.label.coreprotect.info.range"));
            ...
            this.addWidget(new WidgetInfoIcon(textFieldRange.getX() + offset, y + 4, Icons.INFO_11, "watson.gui.label.coreprotect.info.source"));
        ...
        label = StringUtils.translate("watson.gui.label.coreprotect.title.time"); // Time
        this.addLabel(x, y, width, 20, 0xFFFFFFFF, label);
        offset = this.getStringWidth(label) + 4;
    ...
    public boolean validate()
    {
        ...
        {
            addMessage(Message.MessageType.WARNING, "watson.error.plugin.invalid_format", StringUtils.translate("watson.gui.label.coreprotect.title.time"), textTime);
            error = true;
        }
