...
public class PluginSearchPacketHandler
{
    ...
    public void sendPacket(List<String> action, List<String> dimension, List<String> block, List<String> entityType, List<String> item, int range, String source, String time, int pages, int x, int y, int z, MinecraftClient mc)
    {
        try
        {
            CoreProtectSearch coreProtectSearch = new CoreProtectSearch(action, dimension, block, entityType, item, range, x, y, z, source, time);
