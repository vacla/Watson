...
public class PluginSearchPacketHandler
{
    ...
    public void sendPacket(List<String> action, List<String> dimension, List<String> object, int range, String source, String timeBefore, String timeAfter, int pages, MinecraftClient mc)
    {
        try
        {
