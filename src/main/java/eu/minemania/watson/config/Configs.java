...
public class Configs implements IConfigHandler {
	...
	private static ImmutableList<String> setWatsonBlockData() {
		...
		IRegistry.BLOCK.forEach((block) -> builder.add(IRegistry.BLOCK.getKey(block).getNamespace() + ":" + IRegistry.BLOCK.getKey(block).getPath() + ";1;14033081"));
		IRegistry.ENTITY_TYPE.forEach((type) -> builder.add(IRegistry.ENTITY_TYPE.getKey(type).getNamespace() + ":" + IRegistry.ENTITY_TYPE.getKey(type).getPath() + ";1;14033081"));
